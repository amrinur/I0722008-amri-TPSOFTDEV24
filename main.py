...
Label(root, text='Sistem Informasi Perpustakaan', font=("M", 15, 'bold'),  bg = "#282C34", foreground= "#ABB2BF").pack(side=TOP, fill=X)
...
Label(left_frame, text='Category', bg=lf_bg, font=lbl_font).place(x=90, y=75)
Entry(left_frame, width=25, font=entry_font, text=author_name).place(x=45, y=85)
...
Label(left_frame, text='Nama Penulis', bg=lf_bg, font=lbl_font).place(x=110, y=105)
